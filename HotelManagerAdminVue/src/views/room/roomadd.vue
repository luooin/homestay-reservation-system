                    ...
                    >
                        ...
                        <el-form-item label="房间类型" prop="type">
                            <el-select
                                ...
                                placeholder="请选择"
                            >
                                <el-option :label="'单人温馨小家'" :value="1">
                                </el-option>
                                <el-option :label="'双人甜蜜小家'" :value="2">
                                </el-option>
                                <el-option :label="'三人成行小家'" :value="3">
                                </el-option>
                                <el-option :label="'四人麻将房'" :value="4">
                                </el-option>
                                <el-option :label="'传统家居大床房'" :value="5">
                                </el-option>
                            </el-select>
                        </el-form-item>
                        ...
                        <el-form-item label="房间详情" prop="introduce">
