...
<template>
    <div class="user-table">
        <el-table :data="tableData" stripe style="width: 100%">
            ...
            <el-table-column prop="introduce" label="房间简介">
            </el-table-column>
                ...
                .then((res) => {
                    ...
                    for (var i = 0; i < this.tableData.length; ++i) {
                        ...
                        switch (this.tableData[i].type) {
                            case 1:
                                this.tableData[i].type = "单人温馨小家";
                                break;
                            case 2:
                                this.tableData[i].type = "双人甜蜜小家";
                                break;
                            case 3:
                                this.tableData[i].type = "三人成行小家";
                                break;
                            case 4:
                                this.tableData[i].type = "四人麻将房";
                                break;
                            case 5:
                                this.tableData[i].type = "传统家居大床房";
                                break;
                        }
                    }
                })
